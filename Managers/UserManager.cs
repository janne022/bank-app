...
namespace bank_app.Managers
{
    public static class UserManager
    {
        ...
        public static void CreateUser(UserType userType, string userId, string userName, string userPassword, string email, string phoneNumber, UserType currentUserType)
        {
            if (userType == UserType.Admin)
            {
                var admin = new Admin(userName, userPassword, email, phoneNumber, currentUserType);
                Users.Add(admin);
            }
            else if (userType == UserType.Client)
            {
                var client = new Client(userName, userPassword, email, phoneNumber, currentUserType);
                Users.Add(client);
            }
        }
