namespace bank_app.Utility.UI.Invokables
{
    ...
    public class Invokable<T1, T2, T3, T4, T5, T6>(Action<T1, T2, T3, T4, T5, T6> action) : IInvokable
    {
        private readonly Action<T1, T2, T3, T4, T5, T6> _action = action;

        public void Invoke(params object[] args)
        {
            _action((T1)args[0], (T2)args[1], (T3)args[2], (T4)args[3], (T5)args[4], (T6)args[5]);
        }
    }
}
