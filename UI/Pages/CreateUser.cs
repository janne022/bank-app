...
namespace bank_app.UI.Pages
{
    internal class CreateUser : Page
    {
        internal override UIComponent LoadPage()
        {
            ...
            var navbar = new Navbar(new List<NavbarItem> { new NavbarItem("Home", PageType.AdminDashboard), new NavbarItem("Transfer", PageType.Transfer),
                new NavbarItem("Transaction", PageType.Transaction), new NavbarItem("Account", PageType.Account)});
