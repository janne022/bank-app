...
namespace bank_app.UI.Pages
{
    public class Transfer : Page
    {
        internal override UIComponent LoadPage()
        {
            ...
            transferGrid.AddFlexComponent(new Form(new List<UIComponent> {new Dropdown<Models.Accounts.Account>(accounts), new InputField("Account ID", false, 34), new InputField("Amount", false, 24) }, new Button(transferInvokable, "Send")));
        ...
        {
            Console.WriteLine($"{account.Balance} {id} {amount}");
        }
    }
}
